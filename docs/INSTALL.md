...
Download `zoo_x5cyelo1txreg_v58581.msi` from release `v31951` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v31951` for pilot groups.
